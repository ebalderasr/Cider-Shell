...
set_if_key_exists org.gnome.desktop.interface font-name "Noto Sans 11"
set_if_key_exists org.gnome.desktop.interface document-font-name "Noto Sans 11"
set_if_key_exists org.gnome.desktop.interface monospace-font-name "Noto Sans Mono 12"
set_if_key_exists org.gnome.desktop.wm.preferences titlebar-font "Noto Sans Bold 11"
