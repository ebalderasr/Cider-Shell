...
check_value "Interface font" org.gnome.desktop.interface font-name "'Inter 11'"
...
check_value "App switch shortcut" org.gnome.desktop.wm.keybindings switch-applications "['<Super>Tab']"
...
check_value "Search shortcut" org.gnome.settings-daemon.plugins.media-keys search "['<Super>space']"
...
check_value_with_dir "Just Perfection accessibility menu" "$HOME/.local/share/gnome-shell/extensions/just-perfection-desktop@just-perfection/schemas" org.gnome.shell.extensions.just-perfection accessibility-menu "false"
check_value_with_dir "Just Perfection power icon" "$HOME/.local/share/gnome-shell/extensions/just-perfection-desktop@just-perfection/schemas" org.gnome.shell.extensions.just-perfection power-icon "false"
check_value_with_dir "Just Perfection startup status" "$HOME/.local/share/gnome-shell/extensions/just-perfection-desktop@just-perfection/schemas" org.gnome.shell.extensions.just-perfection startup-status "0"
